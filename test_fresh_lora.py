#!/usr/bin/env python3
"""
Fresh LoRA Training Test
Creates a new child and tests LoRA training from scratch
"""
...
class FreshLoRATest:
    def __init__(self, api_url="https://96iel181wyyyw4-8000.proxy.runpod.net"):
    ...
    def upload_images(self):
        ...
        images_dir = Path("/Users/antenehnegash/Downloads/aman")
    ...
    def test_generation(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                # Save the image
                output_path = f"generated_fresh_{self.child_id}.jpg"
    ...
    def run_fresh_test(self):
        ...
        logger.info("🚀 Starting Fresh LoRA Training Test")
        logger.info("=" * 60)
